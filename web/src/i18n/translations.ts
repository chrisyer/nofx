...
export const translations = {
  en: {
    ...
    reversePositionOn: 'Reverse',
    reversePositionOff: 'Normal',
    reversePositionHint: 'When enabled, LONG signals execute as SHORT and vice versa, with SL/TP swapped',
  ...
  zh: {
    ...
    reversePosition: '反向仓位',
    reversePositionOn: '反向',
    reversePositionOff: '正向',
    reversePositionHint: '开启后，AI 做多信号将反向执行为做空，止损止盈同步反转',
  ...
  id: {
    ...
    reversePosition: 'Posisi Terbalik',
    reversePositionOn: 'Terbalik',
    reversePositionOff: 'Normal',
    reversePositionHint: 'Saat diaktifkan, sinyal LONG dieksekusi sebagai SHORT dan sebaliknya, dengan SL/TP ditukar',
